          ...
          // j[1] is the data JSON object
        	...
        	// Main car's localization Data
          	...
          	auto sensor_fusion = j[1]["sensor_fusion"];
                ...
                // Some code are from the course of Udacity
                ...
                //calculate how to break up spline points so that the vehicle moves at the desired reference velocity
                ...
                for (int i = 1; i <= 50-previous_path_x.size(); i++)
                {
                  ...
                  // rotate back to normal after retating it earlier
